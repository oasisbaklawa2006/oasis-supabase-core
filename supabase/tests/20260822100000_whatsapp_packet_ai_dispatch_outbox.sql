...
select is((select packet_revision from public.whatsapp_packet_ai_dispatch_jobs where packet_id=(select packet_id from public.whatsapp_messages where id='86200000-0000-0000-0000-000000000011') and execution_kind='PACKET'),1::bigint,'message A creates revision 1');
...
select is((select packet_revision from public.whatsapp_packet_ai_dispatch_jobs where packet_id=(select packet_id from public.whatsapp_messages where id='86200000-0000-0000-0000-000000000011') and execution_kind='PACKET'),2::bigint,'correction creates revision 2');
select is((select logical_dispatch_key from public.whatsapp_packet_ai_dispatch_jobs where packet_id=(select packet_id from public.whatsapp_messages where id='86200000-0000-0000-0000-000000000011') and execution_kind='PACKET'),'packet:'||(select packet_id::text from public.whatsapp_messages where id='86200000-0000-0000-0000-000000000011')||':revision:2','revision 2 receives a distinct logical dispatch key');
...
select is((select packet_revision from public.whatsapp_packet_ai_dispatch_jobs where packet_id=(select packet_id from public.whatsapp_messages where id='86200000-0000-0000-0000-000000000011') and execution_kind='PACKET'),2::bigint,'replaying same correction does not create another revision');
...
select is((select packet_revision from public.whatsapp_packet_ai_dispatch_jobs where packet_id=(select packet_id from public.whatsapp_messages where id='86200000-0000-0000-0000-000000000011') and execution_kind='PACKET'),2::bigint,'outbound messages cannot create commercial processing revisions');
