...
comment on function public.buyer_product_prices_v1() is
  'Authenticated buyer price and MOQ contract v1. Returns current approved B2B selling prices plus customer-safe minimum quantity and order increment rules.';
