-- Withhold packed quantity until packing is complete enough for customer visibility.
...
comment on function public.customer_order_items_v1() is
  'Customer-safe order-line projection. Packed quantity remains hidden until the order is packed-ready or later.';
