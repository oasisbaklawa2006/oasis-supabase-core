...
Preview ledger reconciliation: the isolated branch now maps semantic-normalization history to canonical migration versions `20260914180000` and `20260914180100`; no production migration history was changed. Exact-head preview checks and Stage-1B certification must run from this marker commit.
