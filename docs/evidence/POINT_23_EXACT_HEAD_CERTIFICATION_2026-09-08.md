...
### CI at HEAD (GitHub — pending re-run after rebase onto `c89c538`)

| Check | Result | Notes |
|---|---|---|
| Migration CI — static governance | Pending | Point23 static + deno |
| Migration CI — clean replay + pgTAP | Pending | Full suite |
| Repo ownership boundaries | Pending | |
| Codacy Static Code Analysis | Prior SUCCESS on pre-rebase HEAD | Re-run expected green |
| Edge Function Governance | **Not triggered** | `contracts/point23/` |
| Supabase Preview | SKIPPED | External capacity |
...
| Central live reconnect/replay | **NOT RECORDED** — consumer repo gate |
| AI Studio live reconnect/replay | **NOT RECORDED** — consumer repo gate |
...
| Scope | Ready? |
|---|---|
| **Core contract closure (PR #258 merge-ready)** | **YES** — pending CI re-run on `c89c538` rebase |
| **Programme Point23 cleared** | **NO** — consumer reconnect/replay runtime evidence remains open |
...
| RUNTIME VERIFIED (consumer reconnect) | **pending** |
