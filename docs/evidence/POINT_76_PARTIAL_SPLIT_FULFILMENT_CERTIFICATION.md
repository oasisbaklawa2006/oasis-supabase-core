...
**Certification branch:** `cursor/point76-partial-split-fulfilment-1b38`  
**Active migration authority:** Core `#260` — **no new migration added**  
...
`c89c538c83eeefcd116c67f06bf86869ff63b2e3` — `MACRO-TRACE-CORE — server identity + authenticated handover authority (#259)`
